...
sbatch --job-name=benchmark_${PARTITION} \
       ...
       --partition=$PARTITION \
       --time=$TIME \
       --wrap="python3 experiments/2024-08-10_optuna/Warcraft_3x4_gp.py"
...
sbatch --job-name=benchmark_${PARTITION} \
       ...
       --partition=$PARTITION \
       --time=$TIME \
       --wrap="python3 experiments/2024-08-10_optuna/Warcraft_3x4_nsga.py"
...
sbatch --job-name=benchmark_${PARTITION} \
       ...
       --partition=$PARTITION \
       --time=$TIME \
       --wrap="python3 experiments/2024-08-10_optuna/Warcraft_3x4_random.py"
...
sbatch --job-name=benchmark_${PARTITION} \
       ...
       --partition=$PARTITION \
       --time=$TIME \
       --wrap="python3 experiments/2024-08-10_optuna/Warcraft_3x4_tpe.py"