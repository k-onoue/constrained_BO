...
if __name__ == '__main__':
    date, solver, objective_function, sampler_name = '2024-08-10', 'optuna', 'Warcraft_3x4', 'random'
    ...
    sampler = optuna.samplers.RandomSampler(seed=1)  # RandomSampler に変更
    num_trials = 10000  # トライアル数を指定
    timeout = 3600 * 2
