...
sbatch --job-name=benchmark_${PARTITION} \
       ...
       --partition=$PARTITION \
       --time=$TIME \
       --wrap="python3 experiments/2024-08-28_botorch/Simple_5d_constrained3_normalized-input_2.py"
...
sbatch --job-name=benchmark_${PARTITION} \
       ...
       --partition=$PARTITION \
       --time=$TIME \
       --wrap="python3 experiments/2024-08-28_botorch/Simple_5d_unconstrained_normalized-input_2.py"